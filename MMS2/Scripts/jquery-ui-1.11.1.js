...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_convertPositionTo: function(d, pos) {
		...
		return {
			top: (
				pos.top	+																 				this.offset.relative.top * mod +										 				this.offset.parent.top * mod -										 				( ( this.cssPosition === "fixed" ? -this.offset.scroll.top : ( scrollIsRootNode ? 0 : this.offset.scroll.top ) ) * mod)
			),
			left: (
				pos.left +																 				this.offset.relative.left * mod +										 				this.offset.parent.left * mod	-										 				( ( this.cssPosition === "fixed" ? -this.offset.scroll.left : ( scrollIsRootNode ? 0 : this.offset.scroll.left ) ) * mod)
			)
		};
	...
	_generatePosition: function( event, constrainPosition ) {
		...
		return {
			top: (
				pageY -																	 				this.offset.click.top	-												 				this.offset.relative.top -												 				this.offset.parent.top +												 				( this.cssPosition === "fixed" ? -this.offset.scroll.top : ( scrollIsRootNode ? 0 : this.offset.scroll.top ) )
			),
			left: (
				pageX -																	 				this.offset.click.left -												 				this.offset.relative.left -												 				this.offset.parent.left +												 				( this.cssPosition === "fixed" ? -this.offset.scroll.left : ( scrollIsRootNode ? 0 : this.offset.scroll.left ) )
			)
		};
	...
	stop: function( event, ui, inst ) {
		...
		$.each(inst.sortables, function() {
			if (this.instance.isOver) {
				...
				inst.cancelHelperRemoval = true;  				this.instance.cancelHelperRemoval = false;  
